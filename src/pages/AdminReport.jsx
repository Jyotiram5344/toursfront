...
import "../css file/adminreport.css";
...
function AdminReport() {
  ...
  const handlePrint = () => {
    ...
    newWindow.document.write("<style>table { width: 100%; border-collapse: collapse; } th, td { border: 1px solid #000; padding: 4px; text-align: left; }</style>");
  ...
  return (
    <div className="adminreport-container">
      ...
      <div className="adminreport-content">
        <h2 className="adminreport-title">Booking Report</h2>
        {error && <p className="adminreport-error">{error}</p>}

        <div className="adminreport-filters">
          <label>
            Start Date:
        ...
        <div ref={tableRef} className="adminreport-table-wrapper">
          <table className="adminreport-table">
            ...
            <tbody>
              ...
              {displayedBookings.length === 0 && (
                <tr>
                  <td colSpan="37" style={{ textAlign: "center" }}>No data available</td>
                </tr>
              )}
            </tbody>
          </table>
